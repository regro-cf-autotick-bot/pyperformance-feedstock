...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyperformance-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14258&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyperformance-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyperformance` can be installed with:

```
conda install pyperformance
```

It is possible to list all of the versions of `pyperformance` available on your platform with:
